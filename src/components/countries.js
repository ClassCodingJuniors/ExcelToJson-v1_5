  ...
  children: [
      { name: "Canada",
          children: [
              {name: "Ontario",
                  children: [
                      {name:"Toronto", value: 3938},
                      {name:"Ottawa", value: 2500},
                      {name:"Kingston", value: 1009} ]},
              {name: "Quebec",
                  children: [
                      { name:"Quebec",value: 3938},
                      { name:"Montreal",value: 5000}],
              },]
      },
      { name: "USA", ville:"Washinton", value: 3812 },
      { name: "Mexico", ville:"Mexico City", value: 6714 },
      { name: "Brasil", ville:"Sao Paulo", value: 1000},
  ],
};
...
export const dataCountries= {
  name: "World",
  children: [
      { name: "Canada", province:"Ontario", capital:"Toronto", value: 3938},
      { name: "Canada", province:"Quebec", capital:"Montreal",value: 9087},
      { name: "USA", capital:"Washinton", value: 3812 },
      { name: "Mexico", capital:"Mexico City", value: 6714 },
      { name: "Brasil", capital:"Sao Paulo", value: 1000},
  ],
}


export const dataoldcountry = {
  key: "World",
  children: [
